...
export { default as TrueFalseQuiz } from "./TrueFalseQuiz";
export { default as FillBlankQuiz } from "./FillBlankQuiz";
...
export type QuizData = MultipleChoiceQuizData | TrueFalseQuizData | FillBlankQuizData;
