...
export const seedCardsFromData = internalMutation({
    handler: async (ctx) => {
        ...
        for (const card of cardsData) {
            ...
            if (!lesson_id) {
                console.log(`⚠️ No lesson found: ${card._lesson_title}`);
                errors++;
                continue;
            }
        ...
        console.log(`✅ Cards: ${inserted} inserted, ${skipped} skipped, ${errors} errors`);
...
export const getStats = internalMutation({
    handler: async (ctx) => {
        ...
        console.log(`📊 Current stats: ${lessons.length} lessons, ${cards.length} cards`);
